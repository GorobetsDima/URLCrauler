...
//    }
    ...
    public static Set<String> getSetOfLinks(String urlAddress, String fileName) {
    ...
    public static void writeToDiffFiles(int n, String urlAddress, String fileName) {
...
//            ThreadCreator.startThreads(urlAddress);
            ...
            ThreadGetSetOfLinks th = new ThreadGetSetOfLinks(n,String.format("%s%s","Thread:",links.iterator().next()), urlAddress, fileName);
            th.start();
            try {
                th.join(500);
            } catch (InterruptedException e) {
                System.out.println("You catched me!");
                e.printStackTrace();
            }
